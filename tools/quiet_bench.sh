...
shift $((OPTIND-1))
TARGETS=("$@"); [ ${#TARGETS[@]} -eq 0 ] && TARGETS=(bench_erf bench_erfc bench_lgamma bench_erfinv bench_gamma bench_beta bench_digamma bench_trigamma bench_gammainv bench_betainv bench_bessel bench_lbeta)
